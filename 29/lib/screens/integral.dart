...
{
  Widget appBarTitle = new Text("Tích phân", style: new TextStyle(color: Colors.white),);
    ...
    return new Scaffold(
      ...
      body: Center(
        ...
        child: ListView(
          children: <Widget>[
            new Image.asset(
              "img_data/img_tp/1.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/2.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/3.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/4.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/5.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/6.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/7.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/8.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/9.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/10.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/11.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/12.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_tp/13.jpg",
              fit: BoxFit.fill,
            ),
          ],
        ),
  ...
  void _handleSearchEnd() {
    setState(() {
      ...
      this.appBarTitle =
      new Text("Tích phân", style: new TextStyle(color: Colors.white),);
      _IsSearching = false;
      _searchQuery.clear();
    });
  }

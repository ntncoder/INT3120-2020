...
{
  Widget appBarTitle = new Text("Lượng giác", style: new TextStyle(color: Colors.white),);
    ...
    return new Scaffold(
      ...
      body: Center(
        ...
        child: ListView(
          children: <Widget>[
            new Image.asset(
              "img_data/img_lg/1.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/2.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/3.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/4.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/5.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/6.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/7.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/8.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/9.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/10.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/11.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/12.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/13.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/14.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/15.jpg",
              fit: BoxFit.fill,
            ),
            new Image.asset(
              "img_data/img_lg/16.jpg",
              fit: BoxFit.fill,
            ),
          ],
        ),
  ...
  void _handleSearchEnd() {
    setState(() {
      ...
      this.appBarTitle =
      new Text("Lượng giác", style: new TextStyle(color: Colors.white),);
      _IsSearching = false;
      _searchQuery.clear();
    });
  }
